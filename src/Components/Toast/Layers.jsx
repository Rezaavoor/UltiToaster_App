...
export default function Layers(props) {
  ...
  const data = {
    layer1Color: timer < 30 ? "#F9E795" : timer < 60 ? "#E2B764" : "#CB8633",
    layer2Color: timer < 30 ? "#E69D41" : timer < 60 ? "#E69D41" : "#C37623",
    layer3Color: timer < 30 ? "#C37623" : timer < 60 ? "#C37623" : "#A35E19",
    layer4Color: "#783E0C",
    whiteHolesColor:
      timer < 30 ? "#F3ECD6" : timer < 60 ? "#E69D41" : "#C37623",
    brownHolesColor: timer < 60 ? "#B07322" : "#783E0C"
  };
  return (
    <svg
    ...
    >
      <g id='Layers' transform='translate(-94.929 -153.904)'>
        ...
        <g id='Brown_holes' data-name='Brown holes' opacity='0.69'>
          <circle
            id='brown_hole'
            data-name='brown hole'
            cx='1'
            cy='1'
            r='1'
            transform='translate(138 219)'
            fill={data.brownHolesColor}
          />
          <circle
            id='brown_hole-2'
            data-name='brown hole'
